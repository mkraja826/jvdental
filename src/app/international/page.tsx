  ...
  return (
    <main>
      ...
      <section className="hero" style={{ minHeight: "auto" }}>
        <div className="hero__copy" style={{ minHeight: 640 }}>
          <div>
            ...
            <p className="hero__description">
              Start with records, clinical review and an online consultation so your trip to Hyderabad is organised around a documented treatment pathway—not assumptions.
            </p>
            <div className="hero__actions">
              <Link className="button button--ghost" href="#costs">See costs & timelines</Link>
              <Link className="button button--ghost" href="#coordinator">Talk to a coordinator</Link>
              <Link className="button" href="/patient/login">Upload my records <span aria-hidden="true">→</span></Link>
            </div>
          </div>
        ...
        <div className="hero__visual" style={{ minHeight: 640 }} aria-label="International patient planning journey">
      ...
      <section className="section">
        ...
        <div className="portal-grid" style={{ marginTop: 56 }}>
      ...
      <section className="section section--tight">
        ...
        <div className="principle-list" style={{ marginTop: 48 }}>
