...
export default async function ClinicBookingsPage() {
  ...
  const [{ data: requests }, { data: clinicians }, { data: payments }] = await Promise.all([
    supabase
      ...
      <div className="portal-layout">
        <aside className="portal-sidebar">
          <nav aria-label="Clinic portal navigation">
            ...
            <Link href="/clinic/bookings">Bookings & appointments</Link>
        ...
        <section className="portal-main">
          ...
          <p className="portal-subtitle">Review website booking requests, confirm the actual appointment time, assign a dentist and see the payment state without exposing patient contact details publicly.</p>
          ...
          <div className="metric-grid">
            ...
            <article className="metric"><span>Total requests</span><strong>{requests?.length ?? 0}</strong></article>
          </div>
