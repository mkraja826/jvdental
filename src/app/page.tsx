...
const completeCare = [
  { title: "General Dentistry", body: "Check-ups, cleaning, preventive care and fillings.", href: "/dental-treatments/general-dentistry", image: "/media/IMG-20260918-WA0029.jpg" },
  { title: "Root Canal & Restorative", body: "Root canal treatment, crowns and bridges.", href: "/dental-treatments/root-canal-treatment", image: "/media/IMG-20260918-WA0022.jpg" },
  { title: "Cosmetic Dentistry", body: "Smile-focused restorative care and professional whitening.", href: "/dental-treatments/cosmetic-dentistry", image: "/media/IMG-20260918-WA0021.jpg" },
...
export default async function Home() {
  ...
  return <main className="home-page"><SiteHeader />
    <section className="hero" aria-labelledby="hero-title"><div className="hero__copy"><div><p className="eyebrow">Dentist-led implant clinic · S R Nagar / Ameerpet · Hyderabad</p><h1 className="display-title" id="hero-title">Personalised implant care<br />{" "}with <em>complete adult dentistry.</em></h1><p className="hero__description">JV Dental brings together experienced clinicians, diagnosis-led planning and complete adult dental care. Implant treatment is planned around your health, function, comfort and long-term maintenance.</p><div className="hero__actions"><Link className="button" href="/book">Request an implant assessment <span aria-hidden="true">→</span></Link><Link className="button button--ghost" href="/dental-implants">Explore dental implants</Link></div></div><p className="hero__note">Treatment begins with clinical assessment and appropriate diagnosis. Online review can support planning before a clinic visit or international travel, but does not replace an in-person dental examination.</p></div><div className="hero__visual home-hero-video" aria-label="JV Dental clinical care and implant treatment" style={homeHeroStyle}><div className="hero-visual-fallback" aria-hidden="true"><span className="hero-visual-fallback__mark">JV</span><strong>Diagnosis-led<br />implant care.</strong><small>3D planning · guided workflows · long-term function</small></div><video className="home-hero-video__media" autoPlay muted loop playsInline preload="metadata" poster={homeHero.url || undefined} aria-hidden="true"><source src="/media/jv-implant-hero.mp4" type="video/mp4" /></video><span className="hero__visual-label">Dentist-led care · implant planning · long-term function</span><div className="hero__visual-copy"><p>JV Dental &amp; Implant Centre</p><strong>Treatment planned around you.</strong></div></div></section>
